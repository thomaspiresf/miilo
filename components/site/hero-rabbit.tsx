...
/**
 * Hero "animação padrão": o logo completo da miilo (coelho + palavra).
 * O coelho se esconde na toca conforme a página rola pra baixo.
 * viewBox baseado em public/logo/icone-miilo.svg (1080×1080).
 */
const HOLE = "#0b0b0b"; // a toca é preta
const HOLE_Y = 850.6; // centro da toca no viewBox
const CLIP_Y = 884; // linha onde o coelho some
const SINK_MAX = 830; // quanto o coelho desce (unidades do viewBox) até sumir
    ...
    <div className="absolute inset-0 flex items-center justify-center bg-sky px-6">
     <div className="flex items-end gap-2 sm:gap-3">
      ...
      >
        ...
        <ellipse cx="539.9" cy={HOLE_Y} rx="270" ry="62" fill={HOLE} />
        ...
        <path d="M269.9,850.6a270,62 0 0 0 540,0Z" fill={HOLE} />
      </svg>
      ...
      <Logo
        variant="wordmark"
        tone="negativo"
        className="mb-1 h-7 w-auto sm:mb-2 sm:h-11"
        priority
      />
     </div>
    </div>
